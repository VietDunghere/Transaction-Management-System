...
* **OPERATOR** (Core Banking System của Ngân hàng đối tác):
  * Đây **không phải** nhân viên nội bộ — OPERATOR là hệ thống core banking của ngân hàng khách hàng, gọi API của HPTRRĐGTC theo thời gian thực
  * Nộp giao dịch mới vào hệ thống để chấm điểm fraud và phân luồng tự động
  * Xem danh sách và chi tiết các giao dịch do chính hệ thống nộp
