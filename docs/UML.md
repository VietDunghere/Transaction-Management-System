...
| UC07.6 | Xem kết quả Reconciliation | ADMIN |
...
| UC05.7 | Xem kết quả đối soát (Reconciliation) | ADMIN | UC này cho phép xem danh sách và chi tiết kết quả các phiên đối soát: giao dịch PENDING_TIMEOUT, discrepancy items và trạng thái resolve |
...
| UC07.6 | Xem kết quả Reconciliation | ADMIN | UC này cho phép xem kết quả phiên đối soát gần nhất: trạng thái (MATCH / MISMATCH / FAILED), số giao dịch PENDING_TIMEOUT, discrepancy items và trạng thái resolve |
