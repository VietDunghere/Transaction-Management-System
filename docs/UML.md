...
| UC07.6 | Xem kết quả Reconciliation | ANALYST, ADMIN |
...
| UC07.6 | Xem kết quả Reconciliation | ANALYST, ADMIN | UC này cho phép xem kết quả phiên đối soát gần nhất: trạng thái (MATCH / MISMATCH / FAILED), số giao dịch PENDING_TIMEOUT, discrepancy items và trạng thái resolve |
