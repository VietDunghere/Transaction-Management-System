...
| UC05.3 | Xem báo cáo giao dịch | MANAGER, ADMIN | UC này cho phép tra cứu danh sách giao dịch với các điều kiện lọc: khoảng thời gian, trạng thái, kênh, ngưỡng fraud_score |
