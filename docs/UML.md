...
| UC02.2 | Xem danh sách giao dịch | OPERATOR, REVIEWER, MANAGER, ADMIN, ANALYST | UC này cho phép người dùng xem danh sách giao dịch trong hệ thống (OPERATOR chỉ thấy giao dịch do chính mình nộp) |
...
| UC03.3 | Xem danh sách hồ sơ vay | OPERATOR, MANAGER, ADMIN, ANALYST | UC này cho phép xem danh sách các hồ sơ vay. OPERATOR chỉ thấy đơn do chính mình nộp; MANAGER/ADMIN/ANALYST thấy tất cả |
